            ...
            <div style="flex: 1;">
                ...
                <el-form ref="form" :inline="true" label-width="90px">
                    ...
                    <el-form-item label="店铺底价">
                        <el-input :value="orderDetail.orderBaseMoney" placeholder="店铺底价"/>
                    </el-form-item>
                    <el-form-item label="导购底价">
                        <el-input :value="orderDetail.orderBaseMoney" placeholder="导购底价"/>
                    </el-form-item>
                ...
                <div class="supplier-box" v-for="(item, index) in orderGoods" :key="'goods-' + index">
                    <div class="supplier-title">
                        ...
                        <span><el-button type="danger" plain
                                         @click="returnMoneyFormVisible = true">直接退款</el-button> </span>
                    </div>
