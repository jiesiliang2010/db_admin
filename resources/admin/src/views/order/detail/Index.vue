  ...
  <el-card>
      ...
      <el-form :model="returnForm" @submit.navite="newsubmit" label-width="83px">
        ...
        <el-form-item label="赔款承担方">
          <el-radio-group v-model="returnForm.compensate_object">
            <el-radio :disabled="this.returnForm.compensate_reason == 1 || this.returnForm.compensate_reason == 2?true:false"  :label="1">商家</el-radio>
            <el-radio  :disabled="this.returnForm.compensate_reason == 1 || this.returnForm.compensate_reason == 2?true:false"  :label="2">平台</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
    ...
    <el-dialog
      ...
      <div  class="dialog-footer" style="margin-top:30px;">
        ...
        <el-button type="primary" @click="statisfySubmitAction==true?doOrderCompensateAction():centerDialogVisible = false">确 定</el-button>
      </div>
    </el-dialog>
  </el-card>
</template>
